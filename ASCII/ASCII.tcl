# 
# Project automation script for ASCII 
# 
# Created for ISE version 13.4
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source ASCII.tcl), then you can
...
proc set_process_props {} {
   ...
   project set "Work Directory" "C:/Users/Fernando/Desktop/SimulacionesX/ASCII/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "aver" -process "Generate IBIS Model"
