The following files were generated for 'enterominaFloat' in directory
...
C Simulation Generator:
   ...
   * enterominaFloat/cmodel/floating_point_v6_0_bitacc_cmodel_lin.zip
   * enterominaFloat/cmodel/floating_point_v6_0_bitacc_cmodel_lin64.zip
   * enterominaFloat/cmodel/floating_point_v6_0_bitacc_cmodel_nt.zip
   * enterominaFloat/cmodel/floating_point_v6_0_bitacc_cmodel_nt64.zip

Generate EJava outputs:
   Please see the core data sheet.

   * demo_tb/tb_enterominaFloat.vhd
...
Generate ISE project file:
   ...
   * enterominaFloat.gise
   * enterominaFloat.xise

Deliver Readme:
   Readme file for the IP.

   * enterominaFloat_readme.txt

Generate FLIST file:
   Text file listing all of the output files produced when a customized core was
   generated in the CORE Generator.

   * enterominaFloat_flist.txt
