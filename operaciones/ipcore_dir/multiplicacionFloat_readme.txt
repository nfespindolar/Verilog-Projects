The following files were generated for 'multiplicacionFloat' in directory
C:\Users\Fernando\Desktop\SimulacionesX\operaciones\ipcore_dir\

Generate XCO file:
   CORE Generator input file containing the parameters used to generate a core.

   * multiplicacionFloat.xco

C Simulation Generator:
   Please see the core data sheet.

   * multiplicacionFloat/cmodel/floating_point_v6_0_bitacc_cmodel_lin.zip
   * multiplicacionFloat/cmodel/floating_point_v6_0_bitacc_cmodel_lin64.zip
   * multiplicacionFloat/cmodel/floating_point_v6_0_bitacc_cmodel_nt.zip
   * multiplicacionFloat/cmodel/floating_point_v6_0_bitacc_cmodel_nt64.zip

Generate EJava outputs:
   Please see the core data sheet.

   * demo_tb/tb_multiplicacionFloat.vhd

Generate Implementation Netlist:
   Binary Xilinx implementation netlist files containing the information
   required to implement the module in a Xilinx (R) FPGA.

   * multiplicacionFloat.ngc
...
Deliver IP Symbol:
   ...
   * multiplicacionFloat.asy

SYM file generator:
   Generate a SYM file for compatibility with legacy flows

   * multiplicacionFloat.sym
...
Generate ISE project file:
   ...
   * multiplicacionFloat.gise
   * multiplicacionFloat.xise

Deliver Readme:
   Readme file for the IP.

   * multiplicacionFloat_readme.txt

Generate FLIST file:
   Text file listing all of the output files produced when a customized core was
   generated in the CORE Generator.

   * multiplicacionFloat_flist.txt
